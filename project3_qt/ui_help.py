...
class UI_Help():
    ...
    def create_input_field(field_name : str, line_edit : QLineEdit, read_only : bool=False) -> QHBoxLayout: 
        ...
        # line_edit.setEnabled(not read_only)
    ...
    def create_anim_btn_feild(field_name : str, anim_btn : AnimatedToggle) -> QGridLayout:
        layout = QGridLayout()
