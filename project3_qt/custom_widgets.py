...
# Custom widget that just fills background with a color
class Color(QWidget):
...
# borrowed from https://www.pythonguis.com/tutorials/pyqt6-animated-widgets/ tutorial
# modified to work with PySide6 
